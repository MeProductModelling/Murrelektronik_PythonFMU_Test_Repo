...
class MVK55165(Fmi3Slave):
    ...
    def __init__(self, **kwargs):
        ...
        self.register_variable(Int32('X4_2', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X4_4', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X5_2', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X5_4', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X6_2', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X6_4', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X7_2', causality=Fmi3Causality.output, description='Actuator Output', ))
        self.register_variable(Int32('X7_4', causality=Fmi3Causality.output, description='Actuator Output', ))

...
from MainDeviceScripts.HeaderPythonfile import  generate_constructor_1
...
def generate_code_from_json_1(data, data_connectors):
    output_code = ""
    ...
    generated_constructor_code = generate_constructor_1(data, di_pins, do_pins)
